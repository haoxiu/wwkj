...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row == 0) {
        ...
        _nickName = [[UILabel alloc]initWithFrame:CGRectMake(cell.frame.size.width*0.47, 0, 150, 44)];
        _nickName.text = [[NSUserDefaults standardUserDefaults] objectForKey:@"nickname"];
        _nickName.textAlignment = NSTextAlignmentRight;
        [cell addSubview:_nickName];
    }if (indexPath.row == 2) {
        _userName = [[UILabel alloc]initWithFrame:CGRectMake(cell.frame.size.width*0.47, 0, 150, 44)];
        ...
        _sexL = [[UILabel alloc]initWithFrame:CGRectMake(cell.frame.size.width*0.47, 0, 150, 44)];
        _sexL.text =[[NSUserDefaults standardUserDefaults] objectForKey:@"sex"];
        _sexL.textAlignment = NSTextAlignmentRight;
        [cell addSubview:_sexL];
    } if (indexPath.row == 4) {
//        regionLabel = [[UILabel alloc] initWithFrame:CGRectMake(cell.frame.size.width*0.47, 0, 150, 44)];
