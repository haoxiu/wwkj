...
- (void)setupStream {
    ...
    //3.创建 XMPPRosterCoreDataStorage 通讯录存储对象
    //通讯录对象是用于管理好友
...
- (BOOL)connect {
    ...
    //登陆用户的JID
    NSString *jidString = [NSString stringWithFormat:@"%@@wxhl",self.username];
//    jidString = @"wxhl@localhost/chenweideMacBook-Pro-3";
...
- (void)addFreind:(NSString *)freindUser {
    ...
    NSString *jid = [NSString stringWithFormat:@"%@@wxhl",freindUser];
